...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference("Auction.count") do
      post auctions_url, params: { auction: { brand: @auction.brand, expired_at: @auction.expired_at, opening_price: @auction.opening_price, price_increment: @auction.price_increment, year: @auction.year } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { brand: @auction.brand, expired_at: @auction.expired_at, opening_price: @auction.opening_price, price_increment: @auction.price_increment, year: @auction.year } }
